...
import '../../widgets/customized_prayertext_widget.dart';
import '../../widgets/customized_prayertime_widget.dart';
...
class HomeScreen extends StatelessWidget {
      ...
      body: LayoutBuilder(
        builder: (context, constraints) {
          if (constraints.maxWidth <= 800) {
            return _buildMobileLayout(screenHeight, formattedTime);
          } else {
            return _buildDesktopLayout(screenHeight, formattedTime);
          }
        },
      ),
    );
  ...
  Widget _buildMobileLayout(double screenHeight, String formattedTime) {
    return Stack(
      children: [
        Container(
  ...
  Widget _buildDesktopLayout(double screenHeight, String formattedTime) {
    return Stack(
      children: [
        Container(
          height: screenHeight * 0.35,
